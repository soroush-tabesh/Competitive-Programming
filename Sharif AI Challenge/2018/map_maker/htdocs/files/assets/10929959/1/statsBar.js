var StatsBar = pc.createScript('statsBarD');
...
StatsBar.prototype.initialize = function() {
    ...
    var self = this;
    this.app.on('logReader:statsBarD', function(stats) {    
         self.statusUpdate(stats);
    });
    this.app.on('logReader:setTurnD', function(turn) {    
         self.setTurn(turn);
    });
...
// StatsBar.prototype.setFirstStats = function(){
//     var params = this.log.resource.map.params;
//     var stats = {
//         health : params[0],
//         money : params[1],
//         turn : params[2],
